...
tam_rcpp_ctt3 <- function(TDAT, WLE, MAXK, EST_WLE, prg, wgt) {
    .Call('_TAM_tam_rcpp_ctt3', PACKAGE='TAM', TDAT, WLE, MAXK, EST_WLE, prg, wgt)
}
...
tam_rcpp_tam_jml_calc_probs <- function(theta, AXsi, B, maxK, resp_ind) {
    .Call('_TAM_tam_rcpp_tam_jml_calc_probs', PACKAGE='TAM', theta, AXsi, B, maxK, resp_ind)
}

tam_rcpp_tam_jml_wle_bbari <- function(rprobs, B1, BB, maxK, resp_ind) {
    .Call('_TAM_tam_rcpp_tam_jml_wle_bbari', PACKAGE='TAM', rprobs, B1, BB, maxK, resp_ind)
}

tam_rcpp_tam_jml_calc_xsi_rr <- function(resp_ind, rprobs, maxK, pweightsM) {
    .Call('_TAM_tam_rcpp_tam_jml_calc_xsi_rr', PACKAGE='TAM', resp_ind, rprobs, maxK, pweightsM)
}
