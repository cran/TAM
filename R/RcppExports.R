...
tam_rcpp_wle_suffstat <- function(RPROBS, CBL, CBB, CBBB, cndim, cnitems, cmaxK, cnstud, resp_ind_bool) {
    .Call('_TAM_tam_rcpp_wle_suffstat', PACKAGE = 'TAM', RPROBS, CBL, CBB, CBBB, cndim, cnitems, cmaxK, cnstud, resp_ind_bool)
}
